...
# 更新日志
  ...
  2017-03-14 网友提醒:书架管理 - 查看书籍 直接JS报错 Cannot read property 'title' of null，数据原因，有些数据没删干净。
             解决方法：delete from ssm_storebook where isbn not in (select id from ssm_book)
